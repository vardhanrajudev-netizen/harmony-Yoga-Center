  ...
  const tutorials: Tutorial[] = useMemo(() => [
    {
      ...
      mentor: 'S. Veeranjaneyulu (Yoga Therapist)'
    },
    {
      id: '2',
            ...
            {[
              {
                ...
                desc: 'Every posture is curated and verified by S. Veeranjaneyulu (Yoga Therapist), combining clinical yoga science with real corrective experience.'
              },
              {
                icon: ShieldCheck,
