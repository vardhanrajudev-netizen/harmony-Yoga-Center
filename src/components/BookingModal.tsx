                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-brand-charcoal/85 max-w-sm mx-auto leading-relaxed">
                      Your VIP passes are now active! S. Veeranjaneyulu (Yoga Therapist) and team will message you on <span className="font-semibold text-brand-emerald">{formData.phone}</span> in the next 15 minutes to coordinate your initial session.
                    </p>
                  </div>
